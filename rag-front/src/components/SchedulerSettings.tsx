...
export default function SchedulerSettings() {
  ...
  return (
    <div className="sched-panel">
      <div className="sched-cards-grid">
        ...
        <div className="sched-card">
          <div className="sched-card-header">
            <Clock className="sched-header-icon" size={18} />
            <div>
              <h2 className="sched-title">Schedule</h2>
              <p className="sched-desc">When and how often the cycle runs.</p>
            </div>
          </div>
        ...
        {/* Card 2: Pipeline & Notifications */}
        <div className="sched-card">
          <div className="sched-card-header">
            <Layers className="sched-header-icon" size={18} />
            <div>
              <h2 className="sched-title">Pipeline &amp; Notifications</h2>
              <p className="sched-desc">How articles are processed and when emails are sent.</p>
            </div>
          </div>
          ...
          <div className="sched-section">
            <label className="sched-toggle-row">
              <span className="sched-field-label">Keyword pre-filter</span>
              <input
                type="checkbox"
                className="sched-toggle"
          ...
          <div className="sched-section">
            <label className="sched-toggle-row">
              <span className="sched-field-label">Always send cycle summary</span>
              <input
                type="checkbox"
                className="sched-toggle"
            ...
            <p className="sched-field-hint">
              When off: email only on new public consultations. When on: also sends a brief summary when none were found.
            </p>
          </div>
        </div>
      ...
      {error && <p className="sched-error-msg sched-error-centered">{error}</p>}
